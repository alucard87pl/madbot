...
{ code: "bsgdisplaynamebattlestargalacticawikibaseurlhttpsgalacticafandomcomshortlabelfordiscordbattlestargalactica", name: "Battlestar Galactica Wiki! ### Base URL https://galactica.fandom.com/ ### Short label (for Discord) Battlestar: Galactica", baseUrl: "https://galactica.fandom.com/ ### Short label (for Discord) Battlestar: Galactica", label: "Battlestar: Galactica" },
];
